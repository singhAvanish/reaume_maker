...
//     projects: Project[];
//     skills: Skills;
//     achievements: string[]; // 👈 Explicitly tell it this is string[]
//   };
...
//           cloudServices: []
//         },
//         achievements: [] // ✅ Now correctly inferred as string[]
//       });
...
//         <input name="phoneNo" placeholder="Phone No" value={formData.phoneNo} onChange={handleChange} />
//         <input name="linkedInLink" placeholder="LinkedIn URL" value={formData.linkedInLink} onChange={handleChange} />
...
//           <div key={idx}>
//             <input name="collegeName" placeholder="College Name" value={college.collegeName} onChange={(e) => handleNestedChange('collegeDetails', idx, e)} />
//             <input name="courseName" placeholder="Course" value={college.courseName} onChange={(e) => handleNestedChange('collegeDetails', idx, e)} />
//             <input name="year" placeholder="Year" value={college.year} onChange={(e) => handleNestedChange('collegeDetails', idx, e)} />
//             <input name="location" placeholder="Location" value={college.location} onChange={(e) => handleNestedChange('collegeDetails', idx, e)} />
//             <button type="button" onClick={() => removeEntry('collegeDetails', idx)}>Delete</button>
//           </div>
//         ))}
//         <button onClick={() => addEntry('collegeDetails')}>Add Education</button>
//       </section>
...
//           <div key={idx}>
//             <input name="company" placeholder="Company" value={exp.company} onChange={(e) => handleNestedChange('experience', idx, e)} />
//             <input name="designation" placeholder="Designation" value={exp.designation} onChange={(e) => handleNestedChange('experience', idx, e)} />
//             <input name="year" placeholder="Year" value={exp.year} onChange={(e) => handleNestedChange('experience', idx, e)} />
//             <input name="location" placeholder="Location" value={exp.location} onChange={(e) => handleNestedChange('experience', idx, e)} />
//             <textarea name="workSummary" placeholder="Work Summary" value={exp.workSummary} onChange={(e) => handleNestedChange('experience', idx, e)} />
//             <button type="button" onClick={() => removeEntry('experience', idx)}>Delete</button>    
//           </div>
//         ))}
...
//           <div key={idx}>
//             <input name="projectName" placeholder="Project Name" value={proj.projectName} onChange={(e) => handleNestedChange('projects', idx, e)} />
//             <input name="tools" placeholder="Tools (comma separated)" value={proj.tools.join(', ')} onChange={(e) => {
//               const toolsArray = e.target.value.split(',').map(tool => tool.trim());
//               const updated = [...formData.projects];
//               updated[idx].tools = toolsArray;
//               setFormData(prev => ({ ...prev, projects: updated }));
//             }} />
//             <textarea name="summary" placeholder="Project Summary" value={proj.summary} onChange={(e) => handleNestedChange('projects', idx, e)} />
//             <button type="button" onClick={() => removeEntry('projects', idx)}>Delete</button>
//           </div>
          
//         ))}
//         <button onClick={() => addEntry('projects')}>Add Project</button>
//       </section>

//       <section>
//         <h2>Skills</h2>
//         <input placeholder="Programming Languages (comma separated)" onChange={(e) => handleListChange('programmingLanguages', e.target.value)} />
//         <input placeholder="Libraries (comma separated)" onChange={(e) => handleListChange('libraries', e.target.value)} />
//         <input placeholder="Tools (comma separated)" onChange={(e) => handleListChange('tools', e.target.value)} />
//         <input placeholder="Database (comma separated)" onChange={(e) => handleListChange('database', e.target.value)} />
//         <input placeholder="Cloud Services (comma separated)" onChange={(e) => handleListChange('cloudServices', e.target.value)} />
//       </section>

//       <section>
//         <h2>Achievements</h2>
//         <textarea placeholder="Achievements (comma separated)" onChange={(e) => handleAchievementsChange(e.target.value)} />
//       </section>
//       <button type="button" onClick={handleSubmit}>Generate Resume PDF</button>
